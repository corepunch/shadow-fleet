...
-- Test 6: Visual test - bitwise OR syntax (fg | bg)
print("")
print("✓ Test 6: Using bitwise OR syntax inline (fg|bg)")
terminal.write_colored("  This is bright yellow text on black background", 
                      terminal.colors.fg_bright_yellow | terminal.colors.bg_black)
print(" <- should be yellow on black, then reset to white on black")
...
print("  • Simple bitwise OR (fg | bg) works")
